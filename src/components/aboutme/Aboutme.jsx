      ...
      <div className={styles.aboutcontainer}>
        <div className={styles.txt}>
          <p className="wow animate__animated animate__fadeInUp">
            ...
            with a good understanding in web development. I enjoy finding
            creative solutions to problems and spend my time experimenting with{" "}
          ...
          <a href="#aboutme">
            <button
              onClick={() =>
                alert("sorry my cv isn't available at the moment.")
              }
        ...
        >
          <img src={codinggif} alt="" width="400px" height="300px" srcset="" />
        </div>
      </div>
    </div>
  );
